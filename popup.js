...
function createListView(jsonData, baseUrl) {
	...
	$.each(list, function(index, item) {
		...
		var link = $().add('<div id = link-' + count + '>' + '<div class="time-container col-xs-3"><span class="time">' + minutes + 'm ' + seconds + 's</div>'
			// +'</span></span>'
			+ '<div style="position:relative;left:-20px" class="col-xs-9">' + '<span id="favicon-btn-' + count + '" class="favIcon-container"><img class="favicon-btn" src="' + item.iconUrl + '"/></span>' + '<span class="link-text"><a target="_blank" href="' + item.pageId + '" id="openlink-' + count + '">' + pageTitle + '</a><span>' + "</div></div>").addClass("col-xs-10");
